...
The user id is generated by Firebase auth.
...
Each item in contests is the key for the contests collection e.g. `Governor`
...
* [aliases]()/ocd-division,country:us,state:ca
...
Aliases are used to generate Firebase keys for candidates and referendums from  [`voterInfoQuery`](https://developers.google.com/civic-information/docs/v2/elections/voterInfoQuery). Some examples:

| Type       | From                        | To                                     |
| ---------- | ----------------------------| -------------------------------------- |
| division   | 18th Congressional District | ocd-division,country:us,state:ca,cd:18 |
| contest    | Lieutenant Governor         | LtGovernor                             |
